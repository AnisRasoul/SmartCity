...
const chartData = {
  series: [45, 30, 15, 10],
  labels: ['Short Stay (1-3 days)', 'Medium Stay (4-7 days)', 'Long Stay (8-14 days)', 'Extended Stay (15+ days)']
}
    ...
    <div class="-mx-8 flex flex-wrap items-center justify-center gap-y-3">
      ...
      <div class="w-full px-8 sm:w-1/2">
        <div class="flex w-full items-center">
          ...
          <p class="flex w-full justify-between text-sm font-medium text-black dark:text-white">
            <span> Medium Stay (4-7 days) </span>
            <span> 30% </span>
          </p>
        </div>
      </div>
      ...
      <div class="w-full px-8 sm:w-1/2">
        <div class="flex w-full items-center">
          ...
          <p class="flex w-full justify-between text-sm font-medium text-black dark:text-white">
            <span> Extended Stay (15+ days) </span>
            <span> 10% </span>
          </p>
        </div>
      </div>
